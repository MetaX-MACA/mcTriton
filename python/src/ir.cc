...
void init_triton_ir(py::module &&m) {
  ...
  py::class_<TritonOpBuilder>(m, "builder", py::module_local(),
      ...
      .def("get_fp8e4nv_ty",
           ...
           [](TritonOpBuilder &self) -> Type {
             // USE_MACA: modify Float8E4M3FNUZType to Float8E4M3FNType
             // For triton kernel's args, dtypes in torch:
             //     float8_e4m3fn   ->  fp8e4nv
             //     float8_e4m3fnuz ->  fpe4b8
             // after calling create_function_from_signature(...), 
             // do the right mapping to support fp8
      ...
      .def("create_load",
           [](TritonOpBuilder &self, Value &ptrs, CacheModifier cacheModifier,
              EvictionPolicy evictionPolicy, bool isVolatile, bool isPipeline) -> Value {
             return self.create<LoadOp>(ptrs, cacheModifier, evictionPolicy,
                                        isVolatile, isPipeline);
           })
#else
      .def("create_load",
           [](TritonOpBuilder &self, Value &ptrs, CacheModifier cacheModifier,
      ...
      .def("create_tensor_pointer_load",
           [](TritonOpBuilder &self, Value &ptr,
              ...
              bool isVolatile, bool isPipeline) -> Value {
      ...
      .def("create_inline_intrinsic",
           [](TritonOpBuilder &self, const std::string &inlineIntrinsic,
              ...
              const std::vector<Type> &types, bool isPure) -> OpState {
