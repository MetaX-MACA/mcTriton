...
#ifdef USE_MACA
class ExtractTensorOpAxisInfoVisitor final : public AxisInfoVisitorImpl<triton::gpu::ExtractTensorOp> {
public:
  ...
  getAxisInfo(triton::gpu::ExtractTensorOp op,
    ...
    auto subSizes = dyn_cast<RankedTensorType>(op.getResult().getType()).getShape();
...
class InsertTensorOpAxisInfoVisitor final : public AxisInfoVisitorImpl<triton::gpu::InsertTensorOp> {
public:
...
class SwizzleTensorOpAxisInfoVisitor final : public AxisInfoVisitorImpl<triton::gpu::SwizzleTensorOp> {
public:
  ...
  getAxisInfo(triton::gpu::SwizzleTensorOp op,
    ...
    auto inOrder = ttg::getOrder(srcBlocked);
    ...
    if ((opConstancy[inOrder[0]] >= srcShape[inOrder[0]]) || (opConstancy[inOrder[0]] == minVec)) {
