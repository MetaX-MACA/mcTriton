...
struct FuncOpConversion : public ConvertOpToLLVMPattern<triton::FuncOp> {
  ...
  triton::FuncOp amendFuncOp(triton::FuncOp funcOp,
    ...
    auto ptrTy = LLVM::LLVMPointerType::get(rewriter.getContext(), this->getTypeConverter()->convertType(rewriter.getI8Type()), 3);
  #else
  ...
  matchAndRewrite(triton::FuncOp funcOp, OpAdaptor adaptor,
    ...
    newFuncOp->setAttr("maca.maxntid",
                       rewriter.getI32ArrayAttr(64 * numWarps));
