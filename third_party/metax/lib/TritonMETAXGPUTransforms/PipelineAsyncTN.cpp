...
struct TritonMETAXGPUPipelineAsyncTNPass
  ...
  TritonMETAXGPUPipelineAsyncTNPass(int numStages) {
...
std::unique_ptr<Pass>
mlir::createTritonMETAXGPUPipelineAsyncTNPass(int numStages) {
  return std::make_unique<TritonMETAXGPUPipelineAsyncTNPass>(numStages);
}
