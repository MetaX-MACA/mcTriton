...
struct ConvertTritonGPUToLLVM
  ...
  ConvertTritonGPUToLLVM(int32_t computeCapability, bool enSmIdxCache,
                         bool enSmIndexOpt)
      : ConvertTritonGPUToLLVMBase({computeCapability}),
        enSmIdxCache(enSmIdxCache), enSmIndexOpt(enSmIndexOpt) {}
  ...
  void runOnOperation() override {
    ...
    mlir::triton::METAX::populateViewOpToLLVMPatterns(
        typeConverter, targetInfo, patterns, axisInfoAnalysis, benefit);
    OpBuilder::InsertPoint indexInsertPointSm;
    mlir::triton::METAX::IndexCacheInfoSm indexCacheInfoSm{
        &baseIndexCacheSm, &indexCacheSm, &indexInsertPointSm};
    mlir::triton::METAX::populateConvertLayoutOpToLLVMPatterns(
        typeConverter, targetInfo, patterns, benefit, indexCacheInfoSm,
        enSmIdxCache, enSmIndexOpt);

    mlir::triton::populateConvertLayoutOpToLLVMPatterns(
        typeConverter, targetInfo, patterns, benefit);

    mlir::triton::METAX::populateDotOpToLLVMPatterns(typeConverter, patterns,
                                                     benefit);
    ...
    mlir::triton::METAX::populateReduceOpToLLVMPatterns(typeConverter, patterns,
                                                        targetInfo, benefit);
...
private:
  DenseMap<mlir::triton::METAX::IndexCacheKeyT, SmallVector<Value>,
...
createConvertTritonGPUToLLVMPass(int32_t computeCapability, bool enSmIdxCache,
                                 bool enSmIndexOpt) {
