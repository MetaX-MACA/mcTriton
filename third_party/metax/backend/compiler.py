...
def ptx_get_version(cuda_version) -> int:
    raise RuntimeError("MACA do not support ptx")
    ...
    def make_mcfatbin(src, metadata, opt, capability):
        ...
        if llvm_version == 19:
            ...
            if "disable-live-range-split" in scenarios:
                compile_options += " -mllvm -metaxgpu-live-range-split=false" # TODO(MACA): workaround for indvarsimplify
